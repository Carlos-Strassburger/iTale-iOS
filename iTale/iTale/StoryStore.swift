...
struct StoryStore {
    ...
    let story = [
        ...
        Story(storyImage: UIImage(imageLiteralResourceName: "cave-entrance"), storyText: "You take the right path, the softer climb with a proper road. As you make your way up the mountain, you notice a cave off to the side of the path. It seems dark and foreboding. What will you do?", choice1: "Investigate the cave", choice2: "Keep moving forward", choiceDestination1: 0, choiceDestination2: 0),
